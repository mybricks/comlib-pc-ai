...
export default comRef(({ data }) => {
  return (
    <TimePicker.RangePicker
      defaultValue={[dayjs('13:30:56', 'HH:mm:ss'), dayjs('18:30:56', 'HH:mm:ss')]} // 使用dayjs来设置defaultValue
      value={[dayjs('13:30:56', 'HH:mm:ss'), dayjs('18:30:56', 'HH:mm:ss')]} // 使用dayjs来设置value
      onChange={([start, end]) => {
        console.log(dayjs(start).format('YYYY-MM-DD HH:mm:ss'))
      }}
    />
  );
}, {
